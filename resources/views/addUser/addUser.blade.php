        ...
        <div class="row mt-5">
            <div class="col-md-5">
                <div class="card">
                    ...
                    <form method="Post" action="{{ route('infoUser.store') }}">
                        @csrf
                        @if ($errors->any())
                                                ...
                                                <tbody>
                                                    @foreach ($user as $item)
                                                        <tr class="align-middle">
                                                            ...
                                                            <td><form style="display:inline-block" method="POST" action="{{route('infoUser.destroy' , $item->id)}}">@csrf<input type="text" name="_method" hidden value="DELETE"><button style="background-color:red;" type="submit" class="btn btn-danger" href="{{route('infoTools.destroy' , $item->id)}}">Delete</button></form>
                                                                <a class="btn btn-warning" href="{{route('infoUser.show' , $item->id)}}">Edit</a>
                                                           </td>
